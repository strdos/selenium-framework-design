@tag
  Feature: Submit a purchase order
    ...
    Scenario Outline: Submit an order with valid data
      ...
      Examples:
        | email            | password   | product         | confirmationMsg
        | alex@test.com    | Test1234!  | ZARA COAT 3     | THANKYOU FOR THE ORDER.
        | alex2@test.com   | Test1234!2 | ADIDAS ORIGINAL | THANKYOU FOR THE ORDER.
